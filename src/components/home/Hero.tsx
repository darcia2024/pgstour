  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#bcd8ee]">
      ...
      <div className="relative mx-auto max-w-4xl px-4 pb-[50vw] pt-24 text-center sm:px-8 sm:pb-[34vw] sm:pt-40 lg:pb-[24rem]">
        ...
        <figure className="mx-auto mt-5 max-w-2xl sm:mt-7">
          <p
            dir="rtl"
            lang="ar"
            className="text-[1.15rem] leading-[1.8] text-ink sm:text-[1.6rem]"
          >
            الْعُمْرَةُ إِلَى الْعُمْرَةِ كَفَّارَةٌ لِمَا بَيْنَهُمَا، وَالْحَجُّ
            الْمَبْرُورُ لَيْسَ لَهُ جَزَاءٌ إِلَّا الْجَنَّةُ
          </p>
          <blockquote className="mt-2 text-pretty text-xs italic leading-relaxed text-ink-soft sm:mt-3 sm:text-[15px]">
          ...
          <figcaption className="mt-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-ink-faint sm:mt-2 sm:text-[12px]">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-2.5 sm:mt-8 sm:flex-row sm:gap-3">
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-ink px-5 py-3 text-xs sm:text-sm font-semibold text-paper-2 shadow-[0_12px_30px_-10px_rgba(12,16,48,0.5)] transition-transform duration-200 hover:-translate-y-0.5 sm:w-auto sm:px-6 sm:py-3.5"
          >
