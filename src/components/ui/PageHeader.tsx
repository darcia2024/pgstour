...
export function PageHeader({
  ...
  return (
    <section className={clsx("relative w-full overflow-hidden bg-ink-2 text-paper-2", className)}>
      ...
      <div
        className={clsx(
          "relative mx-auto w-full px-5 pb-9 pt-28 sm:px-8 sm:pb-12 sm:pt-32",
      ...
      >
        ...
        <h1 className="headline max-w-[26ch] text-[1.75rem] leading-[1.08] text-paper-2 sm:text-[2.4rem] lg:text-[2.8rem]">
          {title}
        </h1>
        {intro ? (
